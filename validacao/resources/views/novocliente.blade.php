                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            <form action="/cliente" method="POST">
                                ...
                                class="form-control {{ $errors->has('nome') ? 'is-invalid':''}}" name="nome" placeholder="Nome do Cliente">
                                @if($errors->has('nome'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="endereco" class="form-control {{ $errors->has('endereco') ? 'is-invalid':'valid-feedback'}}" name="endereco" placeholder="Endereco do Cliente">
